<template>
  ...
  >
    <img
      :src="props.imgDisplay? props.imgDisplay : props.bgImg"
      :class="props.imgSize"
...
import { ref } from 'vue'
const props = defineProps(['title', 'description', 'bgImg', 'imgDisplay', 'imgSize', 'frameSize', 'linkTo', 'linkToPdf','linkToExt'])
